...
|---|------|----------------|--------|------|
| 001 | dashboard-desktop-layout | Does 40/60 panel-on-left + map-on-right feel right at ≥1024px, or should the map breathe more? | _pending_ | layout, desktop, hierarchy |
| 002 | state-card-anatomy | How to show 3 redundant signals + hazard list + sources without clutter (works for desktop panel and mobile card)? | _planned_ | atom, badge, card |
